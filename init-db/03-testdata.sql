...
VALUES 
    ...
    ('11111111-1111-1111-1111-111111111112', NOW() - INTERVAL '25 days', NOW(), 
     'JP', 'TEST-JP-002', '/data/vehicles/jp/002', 1, 1),  -- SUV, ACTIVE
    ('11111111-1111-1111-1111-111111111113', NOW() - INTERVAL '20 days', NOW(), 
     'JP', 'TEST-JP-003', '/data/vehicles/jp/003', 5, 2),  -- COMPACT, MAINTENANCE
    
    -- US vehicles
    ('11111111-1111-1111-1111-111111111114', NOW() - INTERVAL '28 days', NOW(), 
     'US', 'TEST-US-001', '/data/vehicles/us/001', 2, 1),  -- TRUCK, ACTIVE
    ('11111111-1111-1111-1111-111111111115', NOW() - INTERVAL '22 days', NOW(), 
     'US', 'TEST-US-002', '/data/vehicles/us/002', 1, 3),  -- SUV, TESTING
    
    -- German vehicles
    ('11111111-1111-1111-1111-111111111116', NOW() - INTERVAL '15 days', NOW(), 
     'DE', 'TEST-DE-001', '/data/vehicles/de/001', 0, 1),  -- SEDAN, ACTIVE
    ('11111111-1111-1111-1111-111111111117', NOW() - INTERVAL '10 days', NOW(), 
     'DE', 'TEST-DE-002', '/data/vehicles/de/002', 4, 4),  -- BUS, OFFLINE
    
    -- Chinese vehicles
    ('11111111-1111-1111-1111-111111111118', NOW() - INTERVAL '18 days', NOW(), 
     'CN', 'TEST-CN-001', '/data/vehicles/cn/001', 3, 1),  -- VAN, ACTIVE
    
    -- Vehicle without country - experimental type
    ('11111111-1111-1111-1111-111111111119', NOW() - INTERVAL '5 days', NOW(), 
...
VALUES
    -- Expert drivers
    ('d1111111-1111-1111-1111-111111111111', NOW() - INTERVAL '2 years', NOW(),
    ...
    -- Advanced drivers
    ('d1111111-1111-1111-1111-111111111112', NOW() - INTERVAL '1 year', NOW(),
    ...
    ('d1111111-1111-1111-1111-111111111113', NOW() - INTERVAL '18 months', NOW(),
    ...
    -- Basic drivers
    ('d1111111-1111-1111-1111-111111111114', NOW() - INTERVAL '8 months', NOW(),
    ...
    ('d1111111-1111-1111-1111-111111111115', NOW() - INTERVAL '6 months', NOW(),
    ...
    -- Trainee drivers
    ('d1111111-1111-1111-1111-111111111116', NOW() - INTERVAL '3 months', NOW(),
    ...
    ('d1111111-1111-1111-1111-111111111117', NOW() - INTERVAL '1 month', NOW(),
    ...
    ('d1111111-1111-1111-1111-111111111118', NOW() - INTERVAL '2 years', NOW(),
    ...
    -- Retired driver
    ('d1111111-1111-1111-1111-111111111119', NOW() - INTERVAL '3 years', NOW(),
    ...
    ('d1111111-1111-1111-1111-111111111120', NOW() - INTERVAL '1 week', NOW(),
...
VALUES 
    ...
    ('22222222-2222-2222-2222-222222222221', NOW() - INTERVAL '7 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222222', NOW() - INTERVAL '6 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222223', NOW() - INTERVAL '5 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222224', NOW() - INTERVAL '4 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222225', NOW() - INTERVAL '3 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222226', NOW() - INTERVAL '2 days', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222227', NOW() - INTERVAL '1 day', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222228', NOW() - INTERVAL '12 hours', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222229', NOW() - INTERVAL '6 hours', NOW(),
    ...
    ('22222222-2222-2222-2222-222222222230', NOW() - INTERVAL '3 hours', NOW(),
...
VALUES 
    ...
    -- Segment 1 (0-30 min)
    ('33333333-3333-3333-3333-333333333331', NOW() - INTERVAL '7 days', NOW(),
    ...
    -- Segment 2 (30-60 min)
    ('33333333-3333-3333-3333-333333333332', NOW() - INTERVAL '7 days', NOW(),
     0, '22222222-2222-2222-2222-222222222221', 
    ...
    ('33333333-3333-3333-3333-333333333333', NOW() - INTERVAL '7 days', NOW(),
     0, '22222222-2222-2222-2222-222222222221', 
    ...
    -- Segment 1
    ('33333333-3333-3333-3333-333333333337', NOW() - INTERVAL '6 days', NOW(),
    ...
    -- Segment 2
    ('33333333-3333-3333-3333-333333333338', NOW() - INTERVAL '6 days', NOW(),
     0, '22222222-2222-2222-2222-222222222222', 
    ...
    ('33333333-3333-3333-3333-333333333340', NOW() - INTERVAL '4 days', NOW(),
    ...
    ('33333333-3333-3333-3333-333333333341', NOW() - INTERVAL '4 days', NOW(),
    ...
    ('33333333-3333-3333-3333-333333333342', NOW() - INTERVAL '2 days', NOW(),
     0, '22222222-2222-2222-2222-222222222226', 
    ...
    ('33333333-3333-3333-3333-333333333343', NOW() - INTERVAL '2 days', NOW(),
    ...
    ('33333333-3333-3333-3333-333333333344', NOW() - INTERVAL '1 day', NOW(),
...
VALUES
    ...
    ('88888888-8888-8888-8888-888888888801', NOW() - INTERVAL '7 days', NOW(),
     'Crosswalk', 0, 0, '33333333-3333-3333-3333-333333333331', 100, 250, NULL, NULL, '/scenes/tokyo_001_seg1/crosswalk.json'),
    ('88888888-8888-8888-8888-888888888802', NOW() - INTERVAL '7 days', NOW(),
    ...
    ('88888888-8888-8888-8888-888888888803', NOW() - INTERVAL '6 days', NOW(),
    ...
    ('88888888-8888-8888-8888-888888888804', NOW() - INTERVAL '4 days', NOW(),
...
VALUES 
    ...
    ('44444444-4444-4444-4444-444444444441', NOW() - INTERVAL '60 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444442', NOW() - INTERVAL '55 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444443', NOW() - INTERVAL '50 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444444', NOW() - INTERVAL '45 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444445', NOW() - INTERVAL '40 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444446', NOW() - INTERVAL '35 days', NOW(),
     'GPS Coordinate Validator', 2, 3, 1, 2,
     NULL,
     '{"coordinate_system": "WGS84", "boundary_check": true, "max_speed": 200, "min_accuracy": 10}'),
    
    -- ML Training Pipelines
    ('44444444-4444-4444-4444-444444444447', NOW() - INTERVAL '30 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444448', NOW() - INTERVAL '25 days', NOW(),
     'Lane Detection Training', 3, 4, 1, 1,
     '{"gpu_required": true, "gpu_count": 2}',
     '{"model": "lanenet", "epochs": 50, "batch_size": 16, "optimizer": "adam"}'),
    
    -- ML Inference Pipelines
    ('44444444-4444-4444-4444-444444444449', NOW() - INTERVAL '20 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444450', NOW() - INTERVAL '18 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444451', NOW() - INTERVAL '15 days', NOW(),
    ...
    ('44444444-4444-4444-4444-444444444452', NOW() - INTERVAL '12 days', NOW(),
     'Report Generation Pipeline', 5, 6, 1, 2,
     '{"template": "standard_report_v2"}',
     '{"output_format": "pdf", "include_charts": true, "language": "en"}'),
    
    -- Data Import Pipelines
    ('44444444-4444-4444-4444-444444444453', NOW() - INTERVAL '10 days', NOW(),
...
VALUES
    -- Raw data entries
    ('55555555-5555-5555-5555-555555555501', NOW() - INTERVAL '30 days', NOW(),
    ...
    ('55555555-5555-5555-5555-555555555502', NOW() - INTERVAL '29 days', NOW(),
    ...
    ('55555555-5555-5555-5555-555555555503', NOW() - INTERVAL '28 days', NOW(),
    ...
    ('55555555-5555-5555-5555-555555555504', NOW() - INTERVAL '27 days', NOW(),
    ...
    ('55555555-5555-5555-5555-555555555505', NOW() - INTERVAL '25 days', NOW(),
    ...
    ('55555555-5555-5555-5555-555555555506', NOW() - INTERVAL '20 days', NOW(),
    ...
    -- Test data entries
    ('55555555-5555-5555-5555-555555555507', NOW() - INTERVAL '15 days', NOW(),
...
VALUES
    -- Completed jobs
    ('66666666-6666-6666-6666-666666666601', NOW() - INTERVAL '25 days', NOW() - INTERVAL '24 days',
    ...
    ('66666666-6666-6666-6666-666666666602', NOW() - INTERVAL '24 days', NOW() - INTERVAL '23 days',
    ...
    -- Running jobs
    ('66666666-6666-6666-6666-666666666603', NOW() - INTERVAL '2 hours', NOW(),
    ...
    -- Pending jobs
    ('66666666-6666-6666-6666-666666666604', NOW() - INTERVAL '1 hour', NOW(),
    ...
    -- Failed jobs
    ('66666666-6666-6666-6666-666666666605', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days',
    ...
    ('66666666-6666-6666-6666-666666666606', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days',
    ...
    ('66666666-6666-6666-6666-666666666607', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days',
    ...
    -- Cancelled job
    ('66666666-6666-6666-6666-666666666608', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day',
...
VALUES
    ...
    ('77777777-7777-7777-7777-777777777701', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days',
    ...
    ('77777777-7777-7777-7777-777777777702', NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days',
     '66666666-6666-6666-6666-666666666601', '66666666-6666-6666-6666-666666666603'),
    
    ('77777777-7777-7777-7777-777777777703', NOW() - INTERVAL '24 days', NOW() - INTERVAL '24 days',
    ...
    ('77777777-7777-7777-7777-777777777704', NOW() - INTERVAL '2 hours', NOW() - INTERVAL '2 hours',
